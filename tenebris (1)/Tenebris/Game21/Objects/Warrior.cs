...
namespace Game21
{
    class Warrior : Hero
    {
        ...
        ReadManager rm;
        public Warrior(Texture2D texture, Vector2 position, bool isWall, Rectangle hitbox, ReadManager rm, ContentManager content, Texture2D fakeTexture) : base(texture, position, isWall, hitbox, rm, content, fakeTexture)
        {
            // Booleans
            doThisOnce = true;
            ManaCostOnce = true;
