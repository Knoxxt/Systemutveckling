...
namespace Game21.Objects
{
    class Mage : Hero
    {
        ...
        ReadManager rm;
        public Mage(Texture2D texture, Vector2 position, bool isWall, Rectangle hitbox, ReadManager rm, ContentManager content, Texture2D fakeTexture) : base(texture, position, isWall, hitbox, rm, content, fakeTexture)
        {
            // Booleans
            doThisOnce = true;
            ManaCostOnce = true;
        ...
        private void Fireball()
        {
            ...
            RangedParticles(pe, "fireparticle", new Vector2(16, 0), false, 25);
        }
